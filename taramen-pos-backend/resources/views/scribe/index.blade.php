                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-v1-user">GET api/v1/user</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-orders-stats">
                                <a href="#endpoints-GETapi-v1-orders-stats">GET api/v1/orders/stats</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-v1-orders--id--status">
                                <a href="#endpoints-PATCHapi-v1-orders--id--status">PATCH api/v1/orders/{id}/status</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-v1-orders--id-">DELETE api/v1/orders/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-discounts">
                                <a href="#endpoints-GETapi-v1-discounts">GET api/v1/discounts</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-discounts">
                                <a href="#endpoints-POSTapi-v1-discounts">POST api/v1/discounts</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-discounts--id-">
                                <a href="#endpoints-GETapi-v1-discounts--id-">GET api/v1/discounts/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-discounts--id-">
                                <a href="#endpoints-PUTapi-v1-discounts--id-">PUT api/v1/discounts/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-discounts--id-">
                                <a href="#endpoints-DELETEapi-v1-discounts--id-">DELETE api/v1/discounts/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-discounts-getActive">
                                <a href="#endpoints-GETapi-v1-discounts-getActive">GET api/v1/discounts/getActive</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-v1-categories--id-">Remove the specified resource from storage.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-menu-items--id--restore">
                                <a href="#endpoints-POSTapi-v1-menu-items--id--restore">POST api/v1/menu-items/{id}/restore</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-v1-menu-items--id--toggle-availability">
                                <a href="#endpoints-PATCHapi-v1-menu-items--id--toggle-availability">PATCH api/v1/menu-items/{id}/toggle-availability</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-menu-items">
                                <a href="#endpoints-GETapi-v1-menu-items">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-menu-items">
                                <a href="#endpoints-POSTapi-v1-menu-items">Store a newly created resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-menu-items--id-">
                                <a href="#endpoints-GETapi-v1-menu-items--id-">Display the specified resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-menu-items--id-">
                                <a href="#endpoints-PUTapi-v1-menu-items--id-">Update the specified resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-menu-items--id-">
                                <a href="#endpoints-DELETEapi-v1-menu-items--id-">Remove the specified resource from storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-v1-employees--id--toggle-status">
                                <a href="#endpoints-PATCHapi-v1-employees--id--toggle-status">PATCH api/v1/employees/{id}/toggle-status</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-employees-all">
                                <a href="#endpoints-GETapi-v1-employees-all">GET api/v1/employees/all</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-v1-employees--id-">DELETE api/v1/employees/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-report">
                                <a href="#endpoints-POSTapi-v1-report">POST api/v1/report</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-orders-stats">GET api/v1/orders/stats</h2>
...
<span id="example-requests-GETapi-v1-orders-stats">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/orders/stats" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"employee_id\": 17,
    \"table_number\": \"mqeopfuudtdsufvyvddqa\",
    \"status\": \"completed\",
    \"date_from\": \"2026-02-05T02:10:12\",
    \"date_to\": \"2107-03-06\",
    \"today\": true,
    \"per_page\": 13,
    \"items\": [
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/orders/stats"
);
...
<span id="example-responses-GETapi-v1-orders-stats">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-orders-stats" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-orders-stats"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-orders-stats"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-orders-stats" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-orders-stats">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-orders-stats" data-method="GET"
      data-path="api/v1/orders/stats"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-orders-stats', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-orders-stats"
                    onclick="tryItOut('GETapi-v1-orders-stats');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-orders-stats"
                    onclick="cancelTryOut('GETapi-v1-orders-stats');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-orders-stats"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/orders/stats</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-orders-stats"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-orders-stats"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               step="any"               name="employee_id"                data-endpoint="GETapi-v1-orders-stats"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the employees table. Example: <code>17</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="table_number"                data-endpoint="GETapi-v1-orders-stats"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="GETapi-v1-orders-stats"
               value="completed"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date_from"                data-endpoint="GETapi-v1-orders-stats"
               value="2026-02-05T02:10:12"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-05T02:10:12</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date_to"                data-endpoint="GETapi-v1-orders-stats"
               value="2107-03-06"
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>date_from</code>. Example: <code>2107-03-06</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="GETapi-v1-orders-stats" style="display: none">
            <input type="radio" name="today"
                   value="true"
                   data-endpoint="GETapi-v1-orders-stats"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="GETapi-v1-orders-stats" style="display: none">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="GETapi-v1-orders-stats"
               value="13"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.menu_item_id"                data-endpoint="GETapi-v1-orders-stats"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the menu_items table. Example: <code>17</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.quantity"                data-endpoint="GETapi-v1-orders-stats"
               value="45"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.discount_id"                data-endpoint="GETapi-v1-orders-stats"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the discounts table. Example: <code>17</code></p>
                    </div>
                                    </details>
        </div>
        </form>

                    <h2 id="endpoints-PATCHapi-v1-orders--id--status">PATCH api/v1/orders/{id}/status</h2>
...
<span id="example-requests-PATCHapi-v1-orders--id--status">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PATCH \
    "http://localhost:8000/api/v1/orders/consequatur/status" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"employee_id\": 17,
...
<span id="example-responses-PATCHapi-v1-orders--id--status">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-PATCHapi-v1-orders--id--status" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-v1-orders--id--status"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-v1-orders--id--status"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-v1-orders--id--status" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-v1-orders--id--status">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-v1-orders--id--status" data-method="PATCH"
      data-path="api/v1/orders/{id}/status"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-v1-orders--id--status', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-v1-orders--id--status"
                    onclick="tryItOut('PATCHapi-v1-orders--id--status');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-orders--id--status"
                    onclick="cancelTryOut('PATCHapi-v1-orders--id--status');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-v1-orders--id--status"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-v1-orders--id--status"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-v1-orders--id--status"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PATCHapi-v1-orders--id--status"
               value="consequatur"
               data-component="url">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="employee_id"                data-endpoint="PATCHapi-v1-orders--id--status"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the employees table. Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="table_number"                data-endpoint="PATCHapi-v1-orders--id--status"
               value="mqeopfuudtdsufvyvddqa"
               data-component="body">
    <br>
<p>Must not be greater than 50 characters. Example: <code>mqeopfuudtdsufvyvddqa</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="PATCHapi-v1-orders--id--status"
               value="pending"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date_from"                data-endpoint="PATCHapi-v1-orders--id--status"
               value="2026-02-05T02:10:12"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-05T02:10:12</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date_to"                data-endpoint="PATCHapi-v1-orders--id--status"
               value="2107-03-06"
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>date_from</code>. Example: <code>2107-03-06</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="PATCHapi-v1-orders--id--status" style="display: none">
            <input type="radio" name="today"
                   value="true"
                   data-endpoint="PATCHapi-v1-orders--id--status"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PATCHapi-v1-orders--id--status" style="display: none">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="PATCHapi-v1-orders--id--status"
               value="13"
               data-component="body">
    <br>
<p>Must be at least 1. Must not be greater than 100. Example: <code>13</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.menu_item_id"                data-endpoint="PATCHapi-v1-orders--id--status"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the menu_items table. Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.quantity"                data-endpoint="PATCHapi-v1-orders--id--status"
               value="45"
               data-component="body">
    <br>
<p>Must be at least 1. Example: <code>45</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.discount_id"                data-endpoint="PATCHapi-v1-orders--id--status"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the discounts table. Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="employee_id"                data-endpoint="GETapi-v1-orders"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the employees table. Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="table_number"                data-endpoint="GETapi-v1-orders"
               value="mqeopfuudtdsufvyvddqa"
               data-component="body">
    <br>
<p>Must not be greater than 50 characters. Example: <code>mqeopfuudtdsufvyvddqa</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.menu_item_id"                data-endpoint="GETapi-v1-orders"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the menu_items table. Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.quantity"                data-endpoint="GETapi-v1-orders"
               value="45"
               data-component="body">
    <br>
<p>Must be at least 1. Example: <code>45</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.discount_id"                data-endpoint="GETapi-v1-orders"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the discounts table. Example: <code>17</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="employee_id"                data-endpoint="POSTapi-v1-orders"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the employees table. Example: <code>17</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="table_number"                data-endpoint="POSTapi-v1-orders"
               value="mqeopfuudtdsufvyvddqa"
               data-component="body">
    <br>
<p>Must not be greater than 50 characters. Example: <code>mqeopfuudtdsufvyvddqa</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date_from"                data-endpoint="POSTapi-v1-orders"
               value="2026-02-05T02:10:12"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-05T02:10:12</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date_to"                data-endpoint="POSTapi-v1-orders"
               value="2107-03-06"
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>date_from</code>. Example: <code>2107-03-06</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="POSTapi-v1-orders"
               value="13"
               data-component="body">
    <br>
<p>Must be at least 1. Must not be greater than 100. Example: <code>13</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.discount_id"                data-endpoint="POSTapi-v1-orders"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the discounts table. Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="employee_id"                data-endpoint="PUTapi-v1-orders--id-"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the employees table. Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="table_number"                data-endpoint="PUTapi-v1-orders--id-"
               value="mqeopfuudtdsufvyvddqa"
               data-component="body">
    <br>
<p>Must not be greater than 50 characters. Example: <code>mqeopfuudtdsufvyvddqa</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date_from"                data-endpoint="PUTapi-v1-orders--id-"
               value="2026-02-05T02:10:13"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-05T02:10:13</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>date_to</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date_to"                data-endpoint="PUTapi-v1-orders--id-"
               value="2107-03-06"
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>date_from</code>. Example: <code>2107-03-06</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="PUTapi-v1-orders--id-" style="display: none">
            <input type="radio" name="today"
                   value="true"
                   data-endpoint="PUTapi-v1-orders--id-"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PUTapi-v1-orders--id-" style="display: none">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="PUTapi-v1-orders--id-"
               value="13"
               data-component="body">
    <br>
<p>Must be at least 1. Must not be greater than 100. Example: <code>13</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.menu_item_id"                data-endpoint="PUTapi-v1-orders--id-"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the menu_items table. Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.discount_id"                data-endpoint="PUTapi-v1-orders--id-"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the discounts table. Example: <code>17</code></p>
...
<p>The ID of the order. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-discounts">GET api/v1/discounts</h2>
...
<span id="example-requests-GETapi-v1-discounts">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/discounts" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/discounts"
);
...
<span id="example-responses-GETapi-v1-discounts">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-discounts" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-discounts"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-discounts"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-discounts" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-discounts">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-discounts" data-method="GET"
      data-path="api/v1/discounts"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-discounts', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-discounts"
                    onclick="tryItOut('GETapi-v1-discounts');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-discounts"
                    onclick="cancelTryOut('GETapi-v1-discounts');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-discounts"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/discounts</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-discounts"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-discounts"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-discounts">POST api/v1/discounts</h2>
...
<span id="example-requests-POSTapi-v1-discounts">
<blockquote>Example request:</blockquote>
...
<div class="bash-example">
    ...
    \"value\": 73,
    \"active\": true,
    \"created_at\": \"2026-02-05T02:10:13\",
    \"updated_at\": \"2026-02-05T02:10:13\",
...
<span id="example-responses-POSTapi-v1-discounts">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-POSTapi-v1-discounts" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-discounts"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-discounts"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-discounts" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-discounts">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-discounts" data-method="POST"
      data-path="api/v1/discounts"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-discounts', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-discounts"
                    onclick="tryItOut('POSTapi-v1-discounts');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-discounts"
                    onclick="cancelTryOut('POSTapi-v1-discounts');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-discounts"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-discounts"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-discounts"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="POSTapi-v1-discounts"
               value="fixed"
               data-component="body">
    <br>
<p>Example: <code>fixed</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>percentage</code></li> <li><code>fixed</code></li> <li><code>buy1take1</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="value"                data-endpoint="POSTapi-v1-discounts"
               value="73"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="POSTapi-v1-discounts" style="display: none">
            <input type="radio" name="active"
                   value="true"
                   data-endpoint="POSTapi-v1-discounts"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-v1-discounts" style="display: none">
...
<p>Example: <code>true</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>menu_items_id</code></b>&nbsp;&nbsp;
<small>string[]</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="menu_items_id[0]"                data-endpoint="POSTapi-v1-discounts"
               data-component="body">
        <input type="text" style="display: none"
               name="menu_items_id[1]"                data-endpoint="POSTapi-v1-discounts"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="created_at"                data-endpoint="POSTapi-v1-discounts"
               value="2026-02-05T02:10:13"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-05T02:10:13</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="updated_at"                data-endpoint="POSTapi-v1-discounts"
               value="2026-02-05T02:10:13"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-05T02:10:13</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-v1-discounts"
               value="mqeopfuudtdsufvyvddqa"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>mqeopfuudtdsufvyvddqa</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-discounts--id-">GET api/v1/discounts/{id}</h2>
...
<span id="example-requests-GETapi-v1-discounts--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/discounts/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/discounts/consequatur"
);
...
<span id="example-responses-GETapi-v1-discounts--id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-discounts--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-discounts--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-discounts--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-discounts--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-discounts--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-discounts--id-" data-method="GET"
      data-path="api/v1/discounts/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-discounts--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-discounts--id-"
                    onclick="tryItOut('GETapi-v1-discounts--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-discounts--id-"
                    onclick="cancelTryOut('GETapi-v1-discounts--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-discounts--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/discounts/{id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-discounts--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-discounts--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-v1-discounts--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the discount. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-discounts--id-">PUT api/v1/discounts/{id}</h2>
...
<span id="example-requests-PUTapi-v1-discounts--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-v1-discounts--id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-PUTapi-v1-discounts--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-discounts--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-discounts--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-discounts--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-discounts--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-discounts--id-" data-method="PUT"
      data-path="api/v1/discounts/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-discounts--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-discounts--id-"
                    onclick="tryItOut('PUTapi-v1-discounts--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-discounts--id-"
                    onclick="cancelTryOut('PUTapi-v1-discounts--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-discounts--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-discounts--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-discounts--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-v1-discounts--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the discount. Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="PUTapi-v1-discounts--id-"
               value="buy1take1"
               data-component="body">
    <br>
<p>Example: <code>buy1take1</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>percentage</code></li> <li><code>fixed</code></li> <li><code>buy1take1</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="value"                data-endpoint="PUTapi-v1-discounts--id-"
               value="73"
               data-component="body">
    <br>
<p>Must be at least 0. Example: <code>73</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="PUTapi-v1-discounts--id-" style="display: none">
            <input type="radio" name="active"
                   value="true"
                   data-endpoint="PUTapi-v1-discounts--id-"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PUTapi-v1-discounts--id-" style="display: none">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="menu_items_id[0]"                data-endpoint="PUTapi-v1-discounts--id-"
               data-component="body">
        <input type="text" style="display: none"
               name="menu_items_id[1]"                data-endpoint="PUTapi-v1-discounts--id-"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the menu_items table.</p>
        </div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="created_at"                data-endpoint="PUTapi-v1-discounts--id-"
               value="2026-02-05T02:10:13"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-05T02:10:13</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="updated_at"                data-endpoint="PUTapi-v1-discounts--id-"
               value="2026-02-05T02:10:13"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-05T02:10:13</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-v1-discounts--id-"
               value="mqeopfuudtdsufvyvddqa"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>mqeopfuudtdsufvyvddqa</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-discounts--id-">DELETE api/v1/discounts/{id}</h2>
...
<span id="example-requests-DELETEapi-v1-discounts--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-v1-discounts--id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-DELETEapi-v1-discounts--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-discounts--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-discounts--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-discounts--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-discounts--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-discounts--id-" data-method="DELETE"
      data-path="api/v1/discounts/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-discounts--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-discounts--id-"
                    onclick="tryItOut('DELETEapi-v1-discounts--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-discounts--id-"
                    onclick="cancelTryOut('DELETEapi-v1-discounts--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-discounts--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-discounts--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-discounts--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-v1-discounts--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the discount. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-discounts-getActive">GET api/v1/discounts/getActive</h2>
...
<span id="example-requests-GETapi-v1-discounts-getActive">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/discounts/getActive" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/discounts/getActive"
);
...
<span id="example-responses-GETapi-v1-discounts-getActive">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-discounts-getActive" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-discounts-getActive"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-discounts-getActive"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-discounts-getActive" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-discounts-getActive">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-discounts-getActive" data-method="GET"
      data-path="api/v1/discounts/getActive"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-discounts-getActive', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-discounts-getActive"
                    onclick="tryItOut('GETapi-v1-discounts-getActive');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-discounts-getActive"
                    onclick="cancelTryOut('GETapi-v1-discounts-getActive');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-discounts-getActive"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/discounts/getActive</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-discounts-getActive"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-discounts-getActive"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/categories/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>The ID of the category. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-menu-items--id--restore">POST api/v1/menu-items/{id}/restore</h2>
...
<span id="example-requests-POSTapi-v1-menu-items--id--restore">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/menu-items/consequatur/restore" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-menu-items--id--restore">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-POSTapi-v1-menu-items--id--restore" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-menu-items--id--restore"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-menu-items--id--restore"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-menu-items--id--restore" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-menu-items--id--restore">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-menu-items--id--restore" data-method="POST"
      data-path="api/v1/menu-items/{id}/restore"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-menu-items--id--restore', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-menu-items--id--restore"
                    onclick="tryItOut('POSTapi-v1-menu-items--id--restore');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-menu-items--id--restore"
                    onclick="cancelTryOut('POSTapi-v1-menu-items--id--restore');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-menu-items--id--restore"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/menu-items/{id}/restore</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-menu-items--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-menu-items--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="POSTapi-v1-menu-items--id--restore"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the menu item. Example: <code>consequatur</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-PATCHapi-v1-menu-items--id--toggle-availability">PATCH api/v1/menu-items/{id}/toggle-availability</h2>
...
<span id="example-requests-PATCHapi-v1-menu-items--id--toggle-availability">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PATCH \
    "http://localhost:8000/api/v1/menu-items/consequatur/toggle-availability" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-PATCHapi-v1-menu-items--id--toggle-availability">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-PATCHapi-v1-menu-items--id--toggle-availability" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-v1-menu-items--id--toggle-availability"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-v1-menu-items--id--toggle-availability"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-v1-menu-items--id--toggle-availability" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-v1-menu-items--id--toggle-availability">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-v1-menu-items--id--toggle-availability" data-method="PATCH"
      data-path="api/v1/menu-items/{id}/toggle-availability"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-v1-menu-items--id--toggle-availability', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-v1-menu-items--id--toggle-availability"
                    onclick="tryItOut('PATCHapi-v1-menu-items--id--toggle-availability');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-menu-items--id--toggle-availability"
                    onclick="cancelTryOut('PATCHapi-v1-menu-items--id--toggle-availability');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-v1-menu-items--id--toggle-availability"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-purple">PATCH</small>
            <b><code>api/v1/menu-items/{id}/toggle-availability</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-v1-menu-items--id--toggle-availability"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-v1-menu-items--id--toggle-availability"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PATCHapi-v1-menu-items--id--toggle-availability"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the menu item. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-menu-items">Display a listing of the resource.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-menu-items">Store a newly created resource in storage.</h2>
...
<div class="bash-example">
    ...
    --form "price=1"\
    --form "available=1"\
    --form "image=@C:\Users\Administrator\AppData\Local\Temp\php3996.tmp" </code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-v1-menu-items"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="category_id"                data-endpoint="POSTapi-v1-menu-items"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="POSTapi-v1-menu-items" style="display: none">
            <input type="radio" name="available"
                   value="true"
                   data-endpoint="POSTapi-v1-menu-items"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-v1-menu-items" style="display: none">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="image"                data-endpoint="POSTapi-v1-menu-items"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\Administrator\AppData\Local\Temp\php3996.tmp</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-v1-menu-items--id-">Display the specified resource.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/menu-items/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/menu-items/consequatur"
);
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-v1-menu-items--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the menu item. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-menu-items--id-">Update the specified resource in storage.</h2>
...
<div class="bash-example">
    ...
    --form "price=1"\
    --form "available="\
    --form "image=@C:\Users\Administrator\AppData\Local\Temp\php3A33.tmp" </code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-v1-menu-items--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the menu item. Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-v1-menu-items--id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="category_id"                data-endpoint="PUTapi-v1-menu-items--id-"
               value=""
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the categories table.</p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="image"                data-endpoint="PUTapi-v1-menu-items--id-"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\Administrator\AppData\Local\Temp\php3A33.tmp</code></p>
        </div>
        </form>

                    <h2 id="endpoints-DELETEapi-v1-menu-items--id-">Remove the specified resource from storage.</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-v1-menu-items--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the menu item. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PATCHapi-v1-employees--id--toggle-status">PATCH api/v1/employees/{id}/toggle-status</h2>
...
<span id="example-requests-PATCHapi-v1-employees--id--toggle-status">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PATCH \
    "http://localhost:8000/api/v1/employees/consequatur/toggle-status" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-PATCHapi-v1-employees--id--toggle-status">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-PATCHapi-v1-employees--id--toggle-status" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-v1-employees--id--toggle-status"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-v1-employees--id--toggle-status"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-v1-employees--id--toggle-status" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-v1-employees--id--toggle-status">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-v1-employees--id--toggle-status" data-method="PATCH"
      data-path="api/v1/employees/{id}/toggle-status"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-v1-employees--id--toggle-status', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-v1-employees--id--toggle-status"
                    onclick="tryItOut('PATCHapi-v1-employees--id--toggle-status');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-employees--id--toggle-status"
                    onclick="cancelTryOut('PATCHapi-v1-employees--id--toggle-status');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-v1-employees--id--toggle-status"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-purple">PATCH</small>
            <b><code>api/v1/employees/{id}/toggle-status</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-v1-employees--id--toggle-status"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-v1-employees--id--toggle-status"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PATCHapi-v1-employees--id--toggle-status"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the employee. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-employees-all">GET api/v1/employees/all</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/employees/all" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/employees/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/employees/consequatur"
);
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-v1-employees--id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<p>The ID of the employee. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-report">POST api/v1/report</h2>
...
<span id="example-requests-POSTapi-v1-report">
<blockquote>Example request:</blockquote>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"start_date\": \"2026-02-05T02:10:14\",
    \"end_date\": \"2107-03-06\"
}"
</code></pre></div>
...
<span id="example-responses-POSTapi-v1-report">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-POSTapi-v1-report" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-report"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-report"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-report" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-report">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-report" data-method="POST"
      data-path="api/v1/report"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-report', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-report"
                    onclick="tryItOut('POSTapi-v1-report');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-report"
                    onclick="cancelTryOut('POSTapi-v1-report');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-report"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-report"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-report"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="start_date"                data-endpoint="POSTapi-v1-report"
               value="2026-02-05T02:10:14"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-05T02:10:14</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="end_date"                data-endpoint="POSTapi-v1-report"
               value="2107-03-06"
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>start_date</code>. Example: <code>2107-03-06</code></p>
        </div>
        </form>
